...
const GenerateTest = () => {
  ...
  const {
    ...
    question_details,
    candidate_answers,
  } = questions[language] ? questions[language][activeQuestion] : {}
  return (
    <>
      <WebCam />
        ...
        !isLinkExpired['expired'] ? (
            ...
            <div className="container">
              {question_details.type == 1 ? (
                <ul>
                  ...
                  <Button
                    className="flex-left"
                    onClick={() => onClickNext(question_details)}
                  >
                    {activeQuestion === questions[language].length - 1
                      ? 'Finish'
                      : 'Next'}
                  </Button>
                </ul>
          ...
          <Layout className="layout parent-container">
            ...
            >
              ...
              <Button className="card-button">Exit Window</Button>
            </Card>
          </Layout>
        ) : isCompleted ? (
